...
```{r}
paste("Good Evening", "Mandy")
```

(@) Can you explain what happened in 2-3 sentences? 

> The paste function added two strings together, this can be useful in the future.
...
>These are different ways to make value comparisons.
...
>This allows for a series of calculations to be made at speed.
...
```{r}
myvalue <- c("Greece", "Bulgaria", "Serbia")
```
...
Is this a means to search things?
...
It is an alphabetized list of federal judges in the US.
